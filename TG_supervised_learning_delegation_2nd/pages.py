...
DecisionNoDelegation / SupervisedLearning → BatchWaitForGroup → Results → (Part 4) GuessDelegation →
...
class BatchWaitForGroup(WaitPage):
    ...
    """
    template_name = 'TG_supervised_learning_delegation_2nd/BatchWaitForGroup.html'
    def is_displayed(self):
