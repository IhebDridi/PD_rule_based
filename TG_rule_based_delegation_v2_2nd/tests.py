"""
10-bot stress test for TG_rule_based_delegation_v2_2nd (human block in Part 1).

Run:
  otree test TG_rule_based_delegation_v2_2nd --num_participants 10

Or:
  .\\scripts\\run_tg_v2_bot_stress.ps1

Checks participant.vars human maps, per-round choice_* fields, and prints submit timings.
With 10 participants, BatchWait forms three trios (9 players); the leftover may quit
from the results wait page to let the runner finish.
"""
...
from shared.tg_v2_bot_stress import BOT_STRESS_NUM_PARTICIPANTS, patch_tg_v2_bot_runner
...
# Document default participant count for stress runs.
assert BOT_STRESS_NUM_PARTICIPANTS == 10
