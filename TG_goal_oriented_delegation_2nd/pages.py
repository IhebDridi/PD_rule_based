"""
TG_goal_oriented_delegation_2nd pages: shared logic in ``pages_classes``, templates in ``templates/TG_goal_oriented_delegation_2nd/``.
"""

_APP = "TG_goal_oriented_delegation_2nd"
