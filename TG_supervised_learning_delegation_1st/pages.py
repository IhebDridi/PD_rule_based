"""
TG_supervised_learning_delegation_1st pages: shared logic in ``pages_classes``, templates in ``templates/TG_supervised_learning_delegation_1st/``.
"""

_APP = "TG_supervised_learning_delegation_1st"
...
from pages_classes.tg_treatment_pages import (
    TgSupervisedAgentFirst,
    TgSupervisedAgentSecond,
)
