...
class AgentProgramming(Page):
    ...
    def before_next_page(self):
        ...
        if current_part == 3:
            ...
            start_round = 2 * Constants.rounds_per_part + 1  # round 21
            ...
            for i in range(1, 11):
                ...
                # ✅ apply only if delegated
                if future.delegate_decision_optional:
                    future.choice = decision
...
class WaitForGroup(WaitPage):
    ...
    def after_all_players_arrive(self):
        ...
        if current_part == 3:
            for p in self.group.get_players():
                anchor = p.in_round(21)

                if not anchor.field_maybe_none("delegate_decision_optional"):
                    continue
