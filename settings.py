...
SESSION_CONFIGS = [
    ...
    dict(
        name='TG_goal_oriented_delegation_1st_with_bots',
        display_name='TG_goal_oriented_delegation_1st_with_bots',
        app_sequence=['TG_goal_oriented_delegation_1st'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
    ...
    dict(
        name='TG_goal_oriented_delegation_2nd_with_bots',
        display_name='TG_goal_oriented_delegation_2nd_with_bots',
        app_sequence=['TG_goal_oriented_delegation_2nd'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
    ...
    dict(
        name='TG_llm_delegation_1st_with_bots',
        display_name='TG_llm_delegation_1st_with_bots',
        app_sequence=['TG_llm_delegation_1st'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
    ...
    dict(
        name='TG_llm_delegation_2nd_with_bots',
        display_name='TG_llm_delegation_2nd_with_bots',
        app_sequence=['TG_llm_delegation_2nd'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
    ...
    dict(
        name='TG_rule_based_delegation_1st_with_bots',
        display_name='TG_rule_based_delegation_1st_with_bots',
        app_sequence=['TG_rule_based_delegation_1st'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
    ...
    dict(
        name='TG_rule_based_delegation_2nd_with_bots',
        display_name='TG_rule_based_delegation_2nd_with_bots',
        app_sequence=['TG_rule_based_delegation_2nd'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
    ...
    dict(
        name='TG_supervised_learning_delegation_1st_with_bots',
        display_name='TG_supervised_learning_delegation_1st_with_bots',
        app_sequence=['TG_supervised_learning_delegation_1st'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
    ...
    dict(
        name='TG_supervised_learning_delegation_2nd_with_bots',
        display_name='TG_supervised_learning_delegation_2nd_with_bots',
        app_sequence=['TG_supervised_learning_delegation_2nd'],
        num_demo_participants=10,
        use_browser_bots=True,
    ),
...
SESSION_CONFIG_DEFAULTS = dict(
    ...
    tg_show_results_diagrams=False,
    # Integrity panel (choice↔payoff, screen↔DB, cache↔DB).
...
# Only apply pool_pre_ping / pool_recycle for PostgreSQL URLs (not SQLite).
# -----------------------------------------------------------------------------
try:
    import sqlalchemy
