...
def custom_export(players):
    ...
    for code, rounds in by_participant.items():
        try:
            ...
            row["Condition"] = "super1st" if Constants.DELEGATION_FIRST else "super2nd"
            ...
            row["SupervisedListChoicesDelegation"] = _strip_allocations(
            ...
            row["SupervisedListChoicesOptional"] = _strip_allocations(
                (
