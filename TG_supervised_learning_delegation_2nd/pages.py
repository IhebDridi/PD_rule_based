"""
TG_supervised_learning_delegation_2nd pages: shared logic in ``pages_classes``, templates in ``templates/TG_supervised_learning_delegation_2nd/``.
"""

_APP = "TG_supervised_learning_delegation_2nd"
